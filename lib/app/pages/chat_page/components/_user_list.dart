...
class UserList extends StatelessWidget {
        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...(isMobileOrTablet ? _topConent : List.from(_topConent.reversed.toList())
                  ..insert(
                    1,
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) => _buildUserTile(context, index, isDark),
            ),
          ),
        ],
      ),
  ...
  Widget _buildUserTile(BuildContext context, int index, bool isDark) {
    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: isSelected ? theme.colorScheme.surface : theme.colorScheme.primaryContainer,
        ),
        child: ListTile(
          contentPadding: EdgeInsets.zero,
            ...
            children: [
              ...
              Flexible(
                child: Text(
                  ...
                  style: textTheme.bodySmall?.copyWith(
                    fontWeight: FontWeight.w600,
                    color: isDark ? AcnooAppColors.kNeutral400 : AcnooAppColors.kNeutral500,
                  ),
                ),
              ),
            ],
