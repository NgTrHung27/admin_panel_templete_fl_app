...
class _ProductImageViewerState extends State<ProductImageViewer> {
  ...
  void initState() {
    imageURLs.clear();
    imageURLs.addAll(
      widget.imageURLs.isEmpty ? eCommerceMockproducts.map((e) => e.imagePath) : widget.imageURLs,
    );
          ...
          child: Container(
            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                return MouseRegion(
                  cursor: _maxedZoom ? SystemMouseCursors.zoomOut : SystemMouseCursors.zoomIn,
