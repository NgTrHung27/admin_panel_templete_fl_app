                                ...
                                children: [
                                  Flexible(
                                    ...
                                    child: showingValueDropDown(
                                        isTablet: isTablet, isMobile: isMobile, textTheme: textTheme),
                                  ),
                              ...
                              Row(
                                ...
                                children: [
                                  Flexible(
                                    flex: 1,
                                    child:
                                        priorityDropDown(textTheme: textTheme, isMobile: isMobile, isTablet: isTablet),
                                  ),
                                  SizedBox(width: _padding),
                                  Expanded(
                                    flex: 2,
                                  ...
                                  children: [
                                    ...
                                    Flexible(
                                      ...
                                      child: priorityDropDown(
                                          textTheme: textTheme, isMobile: isMobile, isTablet: isTablet),
                                    ),
                                  ],
                                ),
                              ),
                    ...
                    decoration: BoxDecoration(
                      color: data.status == 'Pending'
                          ...
                          : data.status == 'InProgress'
                              ...
                              : data.status == 'New'
                                  ? AcnooAppColors.kPrimary500.withValues(alpha: 0.2)
                  ...
                  PopupMenuButton<int>(
                    ...
                    onSelected: (value) {
                      return switch (value) {
                        ...
                        /*'Edit'*/ 1 => ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
